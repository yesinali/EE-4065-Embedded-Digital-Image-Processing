...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "mlp_fsdd_model"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0xa2ffe669ddd2caf9fe1becd4bae11c51"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0xace2ef7cf5597132)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,26}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_CHANNEL     (26)
#define STAI_NETWORK_IN_1_RANK        (1)
#define STAI_NETWORK_IN_1_SIZE        (26)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (104)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (55240)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (55240)
#define STAI_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4,4,4,4,4,4}
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 10400,400,40000,400,4000,40}
#define STAI_NETWORK_WEIGHTS_NUM        (6)
#define STAI_NETWORK_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_1_SIZE        (10400)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (10400)
