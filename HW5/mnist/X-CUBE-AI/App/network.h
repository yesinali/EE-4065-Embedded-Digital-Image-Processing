...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "mnist_my_training"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0xe9905169a2b5cc4823f2d788a84c8381"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0xbeea69524c68a723)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,7}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_CHANNEL     (7)
#define STAI_NETWORK_IN_1_RANK        (1)
#define STAI_NETWORK_IN_1_SIZE        (7)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (28)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (800)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (800)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (800)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (800)
#define STAI_NETWORK_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_NETWORK_WEIGHTS_NUM                  (6)
#define STAI_NETWORK_WEIGHTS_SIZE                  (47640)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (47640)
#define STAI_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4,4,4,4,4,4}
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 2800,400,40000,400,4000,40}
#define STAI_NETWORK_WEIGHTS_NUM        (6)
#define STAI_NETWORK_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_1_SIZE        (2800)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (2800)
#define STAI_NETWORK_WEIGHT_2_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_2_SIZE        (400)
#define STAI_NETWORK_WEIGHT_2_SIZE_BYTES  (400)
#define STAI_NETWORK_WEIGHT_3_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_3_SIZE        (40000)
#define STAI_NETWORK_WEIGHT_3_SIZE_BYTES  (40000)
#define STAI_NETWORK_WEIGHT_4_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_4_SIZE        (400)
#define STAI_NETWORK_WEIGHT_4_SIZE_BYTES  (400)
#define STAI_NETWORK_WEIGHT_5_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_5_SIZE        (4000)
#define STAI_NETWORK_WEIGHT_5_SIZE_BYTES  (4000)
#define STAI_NETWORK_WEIGHT_6_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_6_SIZE        (40)
#define STAI_NETWORK_WEIGHT_6_SIZE_BYTES  (40)
