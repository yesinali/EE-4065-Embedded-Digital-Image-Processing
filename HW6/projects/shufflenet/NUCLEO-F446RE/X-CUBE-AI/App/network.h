...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "shufflenet_digit"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x8f597c6ef596b2933d1aeaa061997c8d"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x6acdc01e1714702b)
...
#define STAI_NETWORK_NODES_NUM           (35)

/*  Macro to declare number macc for generated network model  */
#define STAI_NETWORK_MACC_NUM            (1988020)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (25976)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (25976)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (25976)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (25976)
#define STAI_NETWORK_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_NETWORK_WEIGHTS_NUM                  (30)
#define STAI_NETWORK_WEIGHTS_SIZE                  (25160)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (25160)
#define STAI_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4}
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 216,96,288,48,108,48,288,96,576,48,108,48,576,192,1152,96,216,96,1152,192,2304,96,216,96,2304,384,12288,512,1280,40}
#define STAI_NETWORK_WEIGHTS_NUM        (30)
#define STAI_NETWORK_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_1_SIZE        (216)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (216)
#define STAI_NETWORK_WEIGHT_2_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_2_SIZE        (96)
#define STAI_NETWORK_WEIGHT_2_SIZE_BYTES  (96)
#define STAI_NETWORK_WEIGHT_3_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_3_SIZE        (288)
#define STAI_NETWORK_WEIGHT_3_SIZE_BYTES  (288)
#define STAI_NETWORK_WEIGHT_4_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_4_SIZE        (48)
#define STAI_NETWORK_WEIGHT_4_SIZE_BYTES  (48)
#define STAI_NETWORK_WEIGHT_5_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_5_SIZE        (108)
#define STAI_NETWORK_WEIGHT_5_SIZE_BYTES  (108)
#define STAI_NETWORK_WEIGHT_6_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_6_SIZE        (48)
#define STAI_NETWORK_WEIGHT_6_SIZE_BYTES  (48)
#define STAI_NETWORK_WEIGHT_7_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_7_SIZE        (288)
#define STAI_NETWORK_WEIGHT_7_SIZE_BYTES  (288)
#define STAI_NETWORK_WEIGHT_8_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_8_SIZE        (96)
#define STAI_NETWORK_WEIGHT_8_SIZE_BYTES  (96)
#define STAI_NETWORK_WEIGHT_9_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_9_SIZE        (576)
#define STAI_NETWORK_WEIGHT_9_SIZE_BYTES  (576)
#define STAI_NETWORK_WEIGHT_10_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_10_SIZE        (48)
#define STAI_NETWORK_WEIGHT_10_SIZE_BYTES  (48)
#define STAI_NETWORK_WEIGHT_11_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_11_SIZE        (108)
#define STAI_NETWORK_WEIGHT_11_SIZE_BYTES  (108)
#define STAI_NETWORK_WEIGHT_12_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_12_SIZE        (48)
#define STAI_NETWORK_WEIGHT_12_SIZE_BYTES  (48)
#define STAI_NETWORK_WEIGHT_13_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_13_SIZE        (576)
#define STAI_NETWORK_WEIGHT_13_SIZE_BYTES  (576)
#define STAI_NETWORK_WEIGHT_14_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_14_SIZE        (192)
#define STAI_NETWORK_WEIGHT_14_SIZE_BYTES  (192)
#define STAI_NETWORK_WEIGHT_15_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_15_SIZE        (1152)
#define STAI_NETWORK_WEIGHT_15_SIZE_BYTES  (1152)
...
#define STAI_NETWORK_WEIGHT_17_SIZE        (216)
#define STAI_NETWORK_WEIGHT_17_SIZE_BYTES  (216)
#define STAI_NETWORK_WEIGHT_18_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_18_SIZE        (96)
#define STAI_NETWORK_WEIGHT_18_SIZE_BYTES  (96)
#define STAI_NETWORK_WEIGHT_19_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_19_SIZE        (1152)
#define STAI_NETWORK_WEIGHT_19_SIZE_BYTES  (1152)
#define STAI_NETWORK_WEIGHT_20_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_20_SIZE        (192)
#define STAI_NETWORK_WEIGHT_20_SIZE_BYTES  (192)
#define STAI_NETWORK_WEIGHT_21_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_21_SIZE        (2304)
#define STAI_NETWORK_WEIGHT_21_SIZE_BYTES  (2304)
#define STAI_NETWORK_WEIGHT_22_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_22_SIZE        (96)
#define STAI_NETWORK_WEIGHT_22_SIZE_BYTES  (96)
#define STAI_NETWORK_WEIGHT_23_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_23_SIZE        (216)
#define STAI_NETWORK_WEIGHT_23_SIZE_BYTES  (216)
#define STAI_NETWORK_WEIGHT_24_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_24_SIZE        (96)
#define STAI_NETWORK_WEIGHT_24_SIZE_BYTES  (96)
#define STAI_NETWORK_WEIGHT_25_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_25_SIZE        (2304)
#define STAI_NETWORK_WEIGHT_25_SIZE_BYTES  (2304)
#define STAI_NETWORK_WEIGHT_26_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_26_SIZE        (384)
#define STAI_NETWORK_WEIGHT_26_SIZE_BYTES  (384)
#define STAI_NETWORK_WEIGHT_27_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_27_SIZE        (12288)
#define STAI_NETWORK_WEIGHT_27_SIZE_BYTES  (12288)
...
#define STAI_NETWORK_WEIGHT_29_SIZE        (1280)
#define STAI_NETWORK_WEIGHT_29_SIZE_BYTES  (1280)
#define STAI_NETWORK_WEIGHT_30_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_30_SIZE        (40)
#define STAI_NETWORK_WEIGHT_30_SIZE_BYTES  (40)
