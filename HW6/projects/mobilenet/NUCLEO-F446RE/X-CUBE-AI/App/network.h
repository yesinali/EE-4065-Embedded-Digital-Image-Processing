...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "mobilenet_digit"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0xf63c4e1bf77f421087c605a3900b9542"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x8971f73b9f622bac)
...
#define STAI_NETWORK_NODES_NUM           (22)

/*  Macro to declare number macc for generated network model  */
#define STAI_NETWORK_MACC_NUM            (2868544)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (30436)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (30436)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (30436)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (30436)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (39944)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (39944)
#define STAI_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4}
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 144,64,144,64,512,128,288,128,1024,128,288,128,2048,256,576,256,4096,256,576,256,8192,512,1152,512,16384,512,1280,40}
#define STAI_NETWORK_WEIGHTS_NUM        (28)
...
#define STAI_NETWORK_WEIGHT_6_SIZE        (128)
#define STAI_NETWORK_WEIGHT_6_SIZE_BYTES  (128)
...
#define STAI_NETWORK_WEIGHT_8_SIZE        (128)
#define STAI_NETWORK_WEIGHT_8_SIZE_BYTES  (128)
#define STAI_NETWORK_WEIGHT_9_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_9_SIZE        (1024)
#define STAI_NETWORK_WEIGHT_9_SIZE_BYTES  (1024)
#define STAI_NETWORK_WEIGHT_10_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_10_SIZE        (128)
#define STAI_NETWORK_WEIGHT_10_SIZE_BYTES  (128)
#define STAI_NETWORK_WEIGHT_11_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_11_SIZE        (288)
#define STAI_NETWORK_WEIGHT_11_SIZE_BYTES  (288)
...
#define STAI_NETWORK_WEIGHT_13_SIZE        (2048)
#define STAI_NETWORK_WEIGHT_13_SIZE_BYTES  (2048)
...
#define STAI_NETWORK_WEIGHT_17_SIZE        (4096)
#define STAI_NETWORK_WEIGHT_17_SIZE_BYTES  (4096)
#define STAI_NETWORK_WEIGHT_18_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_18_SIZE        (256)
#define STAI_NETWORK_WEIGHT_18_SIZE_BYTES  (256)
#define STAI_NETWORK_WEIGHT_19_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_19_SIZE        (576)
#define STAI_NETWORK_WEIGHT_19_SIZE_BYTES  (576)
#define STAI_NETWORK_WEIGHT_20_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_20_SIZE        (256)
#define STAI_NETWORK_WEIGHT_20_SIZE_BYTES  (256)
#define STAI_NETWORK_WEIGHT_21_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_21_SIZE        (8192)
#define STAI_NETWORK_WEIGHT_21_SIZE_BYTES  (8192)
...
#define STAI_NETWORK_WEIGHT_23_SIZE        (1152)
#define STAI_NETWORK_WEIGHT_23_SIZE_BYTES  (1152)
...
#define STAI_NETWORK_WEIGHT_25_SIZE        (16384)
#define STAI_NETWORK_WEIGHT_25_SIZE_BYTES  (16384)
...
#define STAI_NETWORK_WEIGHT_27_SIZE        (1280)
#define STAI_NETWORK_WEIGHT_27_SIZE_BYTES  (1280)
