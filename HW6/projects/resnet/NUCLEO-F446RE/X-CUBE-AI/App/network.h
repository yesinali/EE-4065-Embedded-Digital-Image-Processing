...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "resnet_digit"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x7bfd705d85e1e343fa16d5069a8a6c68"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x60c29dcdeeb459da)
...
#define STAI_NETWORK_MACC_NUM            (20231696)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (35104)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (35104)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (35104)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (35104)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (176120)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (176120)
#define STAI_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4}
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 144,64,2304,64,2304,64,2304,64,2304,64,512,128,4608,128,9216,128,9216,128,9216,128,18432,256,36864,256,2048,256,36864,256,36864,256,640,40}
#define STAI_NETWORK_WEIGHTS_NUM        (32)
...
#define STAI_NETWORK_WEIGHT_3_SIZE        (2304)
#define STAI_NETWORK_WEIGHT_3_SIZE_BYTES  (2304)
...
#define STAI_NETWORK_WEIGHT_5_SIZE        (2304)
#define STAI_NETWORK_WEIGHT_5_SIZE_BYTES  (2304)
...
#define STAI_NETWORK_WEIGHT_7_SIZE        (2304)
#define STAI_NETWORK_WEIGHT_7_SIZE_BYTES  (2304)
...
#define STAI_NETWORK_WEIGHT_9_SIZE        (2304)
#define STAI_NETWORK_WEIGHT_9_SIZE_BYTES  (2304)
...
#define STAI_NETWORK_WEIGHT_12_SIZE        (128)
#define STAI_NETWORK_WEIGHT_12_SIZE_BYTES  (128)
#define STAI_NETWORK_WEIGHT_13_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_13_SIZE        (4608)
#define STAI_NETWORK_WEIGHT_13_SIZE_BYTES  (4608)
#define STAI_NETWORK_WEIGHT_14_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_14_SIZE        (128)
#define STAI_NETWORK_WEIGHT_14_SIZE_BYTES  (128)
#define STAI_NETWORK_WEIGHT_15_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_15_SIZE        (9216)
#define STAI_NETWORK_WEIGHT_15_SIZE_BYTES  (9216)
#define STAI_NETWORK_WEIGHT_16_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_16_SIZE        (128)
#define STAI_NETWORK_WEIGHT_16_SIZE_BYTES  (128)
#define STAI_NETWORK_WEIGHT_17_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_17_SIZE        (9216)
#define STAI_NETWORK_WEIGHT_17_SIZE_BYTES  (9216)
...
#define STAI_NETWORK_WEIGHT_19_SIZE        (9216)
#define STAI_NETWORK_WEIGHT_19_SIZE_BYTES  (9216)
...
#define STAI_NETWORK_WEIGHT_21_SIZE        (18432)
#define STAI_NETWORK_WEIGHT_21_SIZE_BYTES  (18432)
...
#define STAI_NETWORK_WEIGHT_23_SIZE        (36864)
#define STAI_NETWORK_WEIGHT_23_SIZE_BYTES  (36864)
...
#define STAI_NETWORK_WEIGHT_25_SIZE        (2048)
#define STAI_NETWORK_WEIGHT_25_SIZE_BYTES  (2048)
#define STAI_NETWORK_WEIGHT_26_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_26_SIZE        (256)
#define STAI_NETWORK_WEIGHT_26_SIZE_BYTES  (256)
#define STAI_NETWORK_WEIGHT_27_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_27_SIZE        (36864)
#define STAI_NETWORK_WEIGHT_27_SIZE_BYTES  (36864)
#define STAI_NETWORK_WEIGHT_28_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_28_SIZE        (256)
#define STAI_NETWORK_WEIGHT_28_SIZE_BYTES  (256)
#define STAI_NETWORK_WEIGHT_29_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_29_SIZE        (36864)
#define STAI_NETWORK_WEIGHT_29_SIZE_BYTES  (36864)
#define STAI_NETWORK_WEIGHT_30_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_30_SIZE        (256)
#define STAI_NETWORK_WEIGHT_30_SIZE_BYTES  (256)
#define STAI_NETWORK_WEIGHT_31_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_31_SIZE        (640)
#define STAI_NETWORK_WEIGHT_31_SIZE_BYTES  (640)
#define STAI_NETWORK_WEIGHT_32_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_32_SIZE        (40)
#define STAI_NETWORK_WEIGHT_32_SIZE_BYTES  (40)
