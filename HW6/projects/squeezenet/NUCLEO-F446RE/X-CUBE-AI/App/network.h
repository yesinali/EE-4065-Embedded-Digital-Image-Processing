...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "squeezenet_digit"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x31e752ba188bd5e7694630c41ef81bfc"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x364dd2bdccfc8e51)
...
#define STAI_NETWORK_NODES_NUM           (23)

/*  Macro to declare number macc for generated network model  */
#define STAI_NETWORK_MACC_NUM            (1468570)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (12544)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (12544)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (12544)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (12544)
#define STAI_NETWORK_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_NETWORK_WEIGHTS_NUM                  (28)
#define STAI_NETWORK_WEIGHTS_SIZE                  (16904)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (16904)
#define STAI_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4}
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 288,128,256,32,1152,64,128,64,256,32,1152,64,128,64,512,64,4608,128,512,128,1024,64,4608,128,512,128,640,40}
#define STAI_NETWORK_WEIGHTS_NUM        (28)
#define STAI_NETWORK_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_1_SIZE        (288)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (288)
#define STAI_NETWORK_WEIGHT_2_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_2_SIZE        (128)
#define STAI_NETWORK_WEIGHT_2_SIZE_BYTES  (128)
#define STAI_NETWORK_WEIGHT_3_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_3_SIZE        (256)
#define STAI_NETWORK_WEIGHT_3_SIZE_BYTES  (256)
#define STAI_NETWORK_WEIGHT_4_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_4_SIZE        (32)
#define STAI_NETWORK_WEIGHT_4_SIZE_BYTES  (32)
#define STAI_NETWORK_WEIGHT_5_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_5_SIZE        (1152)
#define STAI_NETWORK_WEIGHT_5_SIZE_BYTES  (1152)
#define STAI_NETWORK_WEIGHT_6_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_6_SIZE        (64)
#define STAI_NETWORK_WEIGHT_6_SIZE_BYTES  (64)
#define STAI_NETWORK_WEIGHT_7_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_7_SIZE        (128)
#define STAI_NETWORK_WEIGHT_7_SIZE_BYTES  (128)
...
#define STAI_NETWORK_WEIGHT_10_SIZE        (32)
#define STAI_NETWORK_WEIGHT_10_SIZE_BYTES  (32)
#define STAI_NETWORK_WEIGHT_11_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_11_SIZE        (1152)
#define STAI_NETWORK_WEIGHT_11_SIZE_BYTES  (1152)
#define STAI_NETWORK_WEIGHT_12_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_12_SIZE        (64)
#define STAI_NETWORK_WEIGHT_12_SIZE_BYTES  (64)
#define STAI_NETWORK_WEIGHT_13_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_13_SIZE        (128)
#define STAI_NETWORK_WEIGHT_13_SIZE_BYTES  (128)
#define STAI_NETWORK_WEIGHT_14_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_14_SIZE        (64)
#define STAI_NETWORK_WEIGHT_14_SIZE_BYTES  (64)
#define STAI_NETWORK_WEIGHT_15_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_15_SIZE        (512)
#define STAI_NETWORK_WEIGHT_15_SIZE_BYTES  (512)
#define STAI_NETWORK_WEIGHT_16_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_16_SIZE        (64)
#define STAI_NETWORK_WEIGHT_16_SIZE_BYTES  (64)
#define STAI_NETWORK_WEIGHT_17_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_17_SIZE        (4608)
#define STAI_NETWORK_WEIGHT_17_SIZE_BYTES  (4608)
#define STAI_NETWORK_WEIGHT_18_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_18_SIZE        (128)
#define STAI_NETWORK_WEIGHT_18_SIZE_BYTES  (128)
...
#define STAI_NETWORK_WEIGHT_20_SIZE        (128)
#define STAI_NETWORK_WEIGHT_20_SIZE_BYTES  (128)
#define STAI_NETWORK_WEIGHT_21_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_21_SIZE        (1024)
#define STAI_NETWORK_WEIGHT_21_SIZE_BYTES  (1024)
#define STAI_NETWORK_WEIGHT_22_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_22_SIZE        (64)
#define STAI_NETWORK_WEIGHT_22_SIZE_BYTES  (64)
#define STAI_NETWORK_WEIGHT_23_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_23_SIZE        (4608)
#define STAI_NETWORK_WEIGHT_23_SIZE_BYTES  (4608)
#define STAI_NETWORK_WEIGHT_24_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_24_SIZE        (128)
#define STAI_NETWORK_WEIGHT_24_SIZE_BYTES  (128)
#define STAI_NETWORK_WEIGHT_25_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_25_SIZE        (512)
#define STAI_NETWORK_WEIGHT_25_SIZE_BYTES  (512)
#define STAI_NETWORK_WEIGHT_26_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_26_SIZE        (128)
#define STAI_NETWORK_WEIGHT_26_SIZE_BYTES  (128)
#define STAI_NETWORK_WEIGHT_27_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_27_SIZE        (640)
#define STAI_NETWORK_WEIGHT_27_SIZE_BYTES  (640)
#define STAI_NETWORK_WEIGHT_28_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_28_SIZE        (40)
#define STAI_NETWORK_WEIGHT_28_SIZE_BYTES  (40)
